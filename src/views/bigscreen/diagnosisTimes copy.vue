<template>
  <div style="height: 100%">
    <d-echart :options="options" ref="echart"></d-echart>
  </div>
</template>

<script>
import dEchart from './echart'
import { formateX } from './utils/tool.js'
export default {
  props: {
    echartsData: {
      require: true,
      ...
      var options = {
        ...
        tooltip: {
          ...
          formatter: function (data) {
            return data[0].name + '<br />' + data[0].value + ' 次<br />' + Math.abs(data[1].value) + ' 次'
          },
          textStyle: {
            color: this.$axisLabelColor,
            fontSize: 12,
