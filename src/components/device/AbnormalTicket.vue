<template>
  <div>
    <el-row style="font-size: 14px">
      <span class="selecttext">工单创建时间：</span>
    ...
    <el-row style="margin-top: 10px; font-size: 14px">
      ...
      <span class="selecttext">关联报警：</span>
      <el-input v-model="relateAlertKey" style="width: 150px"></el-input>
      <span class="selecttext">报警来源：</span>
      ...
      <span class="selecttext"> 检测专业：</span>
...
export default {
  ...
  mounted() {
    this.innerDeviceCode = this.nodeId
