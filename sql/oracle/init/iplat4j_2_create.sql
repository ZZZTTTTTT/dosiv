...
(
 EVENT_ID           VARCHAR2(64) default ' '      not null,
 BLOCK_ENAME        VARCHAR2(32) default 'result' not null,
 FIELD_ENAME        VARCHAR2(32) default ' '      not null,
 FIELD_CNAME        VARCHAR2(64),
 FIELD_TYPE         VARCHAR2(32),
 FIELD_LENGTH       NUMBER(11,0),
 FIELD_SCALE_LENGTH NUMBER(11,0),
 FIELD_SORT_ID      NUMBER(11,0),
...
CREATE TABLE TEDCM02 (
  CASCADE_ID VARCHAR2(100)  DEFAULT ' '    NOT NULL ,
  CASCADE_CODESET_CODE VARCHAR2(100)  DEFAULT ' '    NOT NULL ,
  CASCADE_TYPE VARCHAR2(1)  DEFAULT ' '    NOT NULL ,
  CODESET_CODE VARCHAR2(64)  DEFAULT ' '    NOT NULL ,
  ITEM_CODE VARCHAR2(64)  DEFAULT ' '    NOT NULL ,
  SUB_CODESET_CODE VARCHAR2(64)  DEFAULT ' '    NOT NULL ,
  SUB_ITEM_CODE VARCHAR2(64)  DEFAULT ' '    NOT NULL ,
  ACTIVE_FLAG VARCHAR2(1)  DEFAULT ' '    NOT NULL ,
  REC_CREATOR VARCHAR2(16)  DEFAULT ' '    NOT NULL ,
  REC_CREATE_TIME VARCHAR2(17)  DEFAULT ' '    NOT NULL ,
  REC_REVISOR VARCHAR2(16)  DEFAULT ' '    NOT NULL ,
  REC_REVISE_TIME VARCHAR2(17)  DEFAULT ' '    NOT NULL ,
...
CREATE TABLE TEWPR00 (
    RULE_KEY VARCHAR2(255) DEFAULT ' ' NOT NULL,
    RULE_PARAM_ENAME VARCHAR2(255) DEFAULT ' ' NOT NULL,
    RULE_PARAM_CNAME VARCHAR2(255) DEFAULT ' ' NOT NULL,
    RULE_PARAM_TYPE VARCHAR2(16) DEFAULT ' ' NOT NULL,
    REC_CREATOR VARCHAR2(255) DEFAULT ' ' NOT NULL,
    REC_CREATE_TIME VARCHAR2(14) DEFAULT ' ' NOT NULL,
    REC_REVISOR VARCHAR2(255) DEFAULT ' ' NOT NULL,
    REC_REVISE_TIME VARCHAR2(14) DEFAULT ' ' NOT NULL,
...
CREATE TABLE TEWPR01 (
    PROCESS_RULE_ID VARCHAR2(255) DEFAULT ' ' NOT NULL,
    PROCESS_RULE_KEY VARCHAR2(255) DEFAULT ' ' NOT NULL,
    PROCESS_RULE_EXPRESSION VARCHAR2(4000) DEFAULT ' ' NOT NULL,
    PROCESS_KEY VARCHAR2(255) DEFAULT ' ' NOT NULL,
    PROCESS_RULE_STATUS VARCHAR2(1) DEFAULT ' ' NOT NULL,
    PROCESS_RULE_REMARK VARCHAR2(4000) DEFAULT ' ' NOT NULL,
    REC_CREATOR VARCHAR2(255) DEFAULT ' ' NOT NULL,
    REC_CREATE_TIME VARCHAR2(14) DEFAULT ' ' NOT NULL,
    REC_REVISOR VARCHAR2(255) DEFAULT ' ' NOT NULL,
    REC_REVISE_TIME VARCHAR2(14) DEFAULT ' ' NOT NULL,
...
CREATE TABLE TEWPR02 (
    BRANCH_RULE_ID VARCHAR2(255) DEFAULT ' ' NOT NULL,
    BRANCH_RULE_KEY VARCHAR2(255) DEFAULT ' ' NOT NULL,
    BRANCH_RULE_EXPRESSION VARCHAR2(4000) DEFAULT ' ' NOT NULL,
    BRANCH_RULE_RESULT VARCHAR2(255) DEFAULT ' ' NOT NULL,
    BRANCH_RULE_STATUS VARCHAR2(1) DEFAULT ' ' NOT NULL,
    BRANCH_RULE_REMARK VARCHAR2(4000) DEFAULT ' ' NOT NULL,
    REC_CREATOR VARCHAR2(255) DEFAULT ' ' NOT NULL,
    REC_CREATE_TIME VARCHAR2(14) DEFAULT ' ' NOT NULL,
    REC_REVISOR VARCHAR2(255) DEFAULT ' ' NOT NULL,
    REC_REVISE_TIME VARCHAR2(14) DEFAULT ' ' NOT NULL,
...
CREATE TABLE TEWPR03 (
    PARTICIPANT_RULE_ID VARCHAR2(255) DEFAULT ' ' NOT NULL,
    PARTICIPANT_RULE_KEY VARCHAR2(255) DEFAULT ' ' NOT NULL,
    PARTICIPANT_RULE_EXPRESSION VARCHAR2(4000) DEFAULT ' ' NOT NULL,
    PARTICIPANT_RULE_STATUS VARCHAR2(1) DEFAULT ' ' NOT NULL,
    PARTICIPANT_RULE_REMARK VARCHAR2(4000) DEFAULT ' ' NOT NULL,
    REC_CREATOR VARCHAR2(255) DEFAULT ' ' NOT NULL,
    REC_CREATE_TIME VARCHAR2(14) DEFAULT ' ' NOT NULL,
    REC_REVISOR VARCHAR2(255) DEFAULT ' ' NOT NULL,
    REC_REVISE_TIME VARCHAR2(14) DEFAULT ' ' NOT NULL,
...
CREATE TABLE TEWPR04 (
    PARTICIPANT_RULE_ID VARCHAR2(255) DEFAULT ' ' NOT NULL,
    PARTICIPANT_ID VARCHAR2(255) DEFAULT ' ' NOT NULL,
    PARTICIPANT_ENAME VARCHAR2(64) DEFAULT ' ' NOT NULL,
    PARTICIPANT_CNAME VARCHAR2(32) DEFAULT ' ' NOT NULL,
    PARTICIPANT_TYPE VARCHAR2(16) DEFAULT ' ' NOT NULL,
    REC_CREATOR VARCHAR2(255) DEFAULT ' ' NOT NULL,
    REC_CREATE_TIME VARCHAR2(14) DEFAULT ' ' NOT NULL,
    REC_REVISOR VARCHAR2(255) DEFAULT ' ' NOT NULL,
    REC_REVISE_TIME VARCHAR2(14) DEFAULT ' ' NOT NULL,
...
CREATE TABLE XS_DATAS_AUTHORIZATION (
  ...
  SQL_ID VARCHAR2(20),
  AUTH_OBJECT_ID VARCHAR2(32) DEFAULT ' ' NOT NULL,
  AUTH_OBJECT_TYPE VARCHAR2(32) DEFAULT ' ' NOT NULL
);
...
CREATE TABLE XS_RESOURCE_GROUP (
  ID VARCHAR2(32)  DEFAULT ' '    NOT NULL ,
  RESOURCE_GROUP_ENAME VARCHAR2(128) ,
...
(
    ...
    ORG_BRIEF_NAME          VARCHAR2(300) not null,
    ORG_TYPE_ID             VARCHAR2(2)   not null,
    ESTABLISH_DATE          VARCHAR2(14),
    REPEAL_DATE             VARCHAR2(14),
    FROM_DATE               VARCHAR2(14),
    TO_DATE                 VARCHAR2(14),
    ALIVE_FLAG              VARCHAR2(1),
    DISPLAY_ORDER           VARCHAR2(16),
    ADDRESS                 VARCHAR2(200),
    ORG_FUNCTION            VARCHAR2(1500),
    ORG_DIMENSION_ID        VARCHAR2(20)  not null,
    TARGET_ORG_MG_CODE      VARCHAR2(16),
    TARGET_ORG_FN_CODE      VARCHAR2(16),
    TARGET_ORG_PT_CODE      VARCHAR2(16),
    TARGET_ORG_GH_CODE      VARCHAR2(16),
    ORG_LEVEL_CODE          VARCHAR2(2)   not null,
    INDUSTRY_CLASSIFY_CODE  VARCHAR2(16),
    INDUSTRY_CLASSIFY_CODE2 VARCHAR2(16),
    ACTIVE_STATUS           VARCHAR2(16),
    REGISTER_NO             VARCHAR2(40),
    REGISTER_DATE           VARCHAR2(8),
    ORG_CERTIFICATE_CODE    VARCHAR2(30),
    LEGAL_REPRESENT         VARCHAR2(30),
    STAT_REGISTER_NO        VARCHAR2(30),
    CHARGE_UNIT_CODE        VARCHAR2(30),
    TAX_REGISTER_NO         VARCHAR2(30),
    REMARK                  VARCHAR2(512)
);
...
(
    EMP_ID               VARCHAR2(16) not null,
    EMP_CODE             VARCHAR2(16) not null,
    EMP_NAME             VARCHAR2(32) not null,
    EMP_NAME_PINYIN      VARCHAR2(64),
    EMP_NAME_AB          VARCHAR2(64),
    EVER_USED_NAME       VARCHAR2(32),
    GENDER               VARCHAR2(2),
    ...
    PARTY                VARCHAR2(16),
    WORK_STATUS          VARCHAR2(16),
    JOIN_COMPANY_DATE    VARCHAR2(20),
    COMPANY_TEL          VARCHAR2(255),
    EMAIL                VARCHAR2(128),
    CURRENT_DUTY         VARCHAR2(16),
    CURRENT_SKILL_LEVEL  VARCHAR2(16),
    EDUCATION_BACKGROUND VARCHAR2(16),
    DEGREE               VARCHAR2(16),
    MAJOR                VARCHAR2(16),
    GRADUATE_DATE        VARCHAR2(20)
);
...
(
    EMP_CODE                 VARCHAR2(16)  default ' ' not null,
    ORG_CODE                 VARCHAR2(16)  default ' ' not null,
    SHIFT                    VARCHAR2(16)  default ' ' not null,
    POSI_FIXED_MEM_TYPE_CODE VARCHAR2(16)  default ' ' not null,
    PERFORM_POSI_ID          VARCHAR2(20)  default ' ' not null,
    PERFORM_POSI             VARCHAR2(200) default ' ' not null,
    POSI_LEVEL_ID            VARCHAR2(16)  default ' ' not null,
    POSI_LEVEL               VARCHAR2(100) default ' ' not null
) ;
...
(
    EMP_CODE        VARCHAR2(4)   not null,
    EMP_ORIGIN_CODE VARCHAR2(4)   not null,
    REC_CREATOR     VARCHAR2(255) not null,
    REC_CREATE_TIME VARCHAR2(14)  not null,
    REC_REVISOR     VARCHAR2(255),
    REC_REVISE_TIME VARCHAR2(14),
...
(
    EVENT_ID        VARCHAR2(64)              not null
        primary key,
    TELE_TYPE       VARCHAR2(20)  default 'text',
    REMOTE_SYS_CODE VARCHAR2(20)  default ' ',
    CATEGORY        VARCHAR2(16)  default '  ',
    REC_CREATOR     VARCHAR2(256) default ' ' not null,
    REC_CREATE_TIME VARCHAR2(14)  default ' ' not null,
    REC_REVISOR     VARCHAR2(256) default ' ' not null,
    REC_REVISE_TIME VARCHAR2(14)  default ' ' not null,
...
(
    TELE_TYPE               VARCHAR2(20)              not null
        primary key,
    TELE_TYPE_DESC          VARCHAR2(250) default ' ' not null,
    TRANS_TELE_SERVICE_ID   VARCHAR2(20)  default ' ' not null,
    TRANS_EIINFO_SERVICE_ID VARCHAR2(20)  default ' ' not null,
    REC_CREATOR             VARCHAR2(256) default ' ' not null,
    REC_CREATE_TIME         VARCHAR2(14)  default ' ' not null,
    REC_REVISOR             VARCHAR2(256) default ' ' not null,
    REC_REVISE_TIME         VARCHAR2(14)  default ' ' not null,
    ARCHIVE_FLAG            VARCHAR2(1)   default ' ' not null,
    TELE_BEAN_TYPE          VARCHAR2(1)   default 0
);
...
(
    ...
    ARCHIVE_KEEP_TIME NUMBER(5)    default 3   not null,
...
(
    OPERATION_ID         VARCHAR2(32)  default ' ' not null
        constraint PK_TEPLG01
        primary key,
    OPERATION_TRACE_ID   VARCHAR2(32)  default ' ' not null,
    OPERATION_SPAN_ID    VARCHAR2(32)  default ' ' not null,
    OPERATION_TYPE_ENAME VARCHAR2(4)   default ' ' not null,
    OPERATION_TYPE_CNAME VARCHAR2(32)  default ' ' not null,
    OPERATOR             VARCHAR2(32)  default ' ' not null,
    OPERATION_DESC       VARCHAR2(512) default ' ' not null,
    OPERATION_TIME       VARCHAR2(17)  default ' ' not null,
    OPERATION_INVOKE_KEY VARCHAR2(512) default ' ' not null,
    REC_CREATOR          VARCHAR2(32)  default ' ' not null,
    REC_CREATE_TIME      VARCHAR2(17)  default ' ' not null,
    REC_REVISOR          VARCHAR2(32)  default ' ' not null,
    REC_REVISE_TIME      VARCHAR2(17)  default ' ' not null,
    ARCHIVE_FLAG         VARCHAR2(1)   default ' ' not null,
    EXT1                 VARCHAR2(3000) default ' ' not null,
    EXT2                 VARCHAR2(3000) default ' ' not null,
    EXT3                 VARCHAR2(3000) default ' ' not null,
    EXT4                 VARCHAR2(3000) default ' ' not null,
    EXT5                 VARCHAR2(3000) default ' ' not null,
    MODULE_NAME          VARCHAR2(32)  default ' ' not null,
    CLIENT_IP          VARCHAR2(32)  default ' ' not null
);
...
comment on column HEPLG02.OPERATION_SPAN_ID is '层级ID';comment on column HEPLG02.OPERATION_TYPE_ENAME is '操作分类';
comment on column HEPLG02.OPERATION_TYPE_CNAME is '操作分类名称';comment on column HEPLG02.OPERATOR is '操作人';
...
(
    ...
    ARCHIVE_FLAG          VARCHAR2(1)  DEFAULT ' '   NOT NULL,
    REC_REVISE_TIME       VARCHAR2(17)  DEFAULT ' '   NOT NULL,
    APP_NAME              VARCHAR2(50)  DEFAULT ' '   NOT NULL,
    KEY_TYPE              VARCHAR2(10)  DEFAULT ' '   NOT NULL,
    SECRET_KEY            VARCHAR2(512)  DEFAULT ' '   NOT NULL,
    ALGORITHM             VARCHAR2(20)  DEFAULT ' '   NOT NULL
) ;
...
(
    ...
    REC_REVISE_TIME       VARCHAR2(17)  DEFAULT ' '   NOT NULL,
    APP_NAME              VARCHAR2(50)  DEFAULT ' '   NOT NULL,
    APP_URL               VARCHAR2(256)  DEFAULT ' '   NOT NULL
) ;
...
-- 对接S3
CREATE TABLE TEUDM05
(
    RES_ID             VARCHAR2(50)                  NOT NULL,
    PROJECT_ENAME      VARCHAR2(50)  DEFAULT ' '     NOT NULL,
    APP_ID             VARCHAR2(50)  DEFAULT ' '     NOT NULL,
    RES_TYPE           VARCHAR2(10)                  NOT NULL,
    RES_ENAME          VARCHAR2(100) DEFAULT ' '     NOT NULL,
    RES_CNAME          VARCHAR2(500) DEFAULT ' '     NOT NULL,
    IS_AUTH            VARCHAR2(1)   DEFAULT '0'     NOT NULL,
    GROUP_ID           VARCHAR2(36)  DEFAULT ' '     NOT NULL,
    STORAGE_TYPE       VARCHAR2(10)  DEFAULT ' '     NOT NULL,
    BUCKET_NAME        VARCHAR2(100) DEFAULT ' '     NOT NULL,
    FILE_EXTENSION     VARCHAR2(100) DEFAULT ' '     NOT NULL,
    FILE_SIZE          NUMBER(20)  DEFAULT 0       NOT NULL,
    FILE_HASH_VALUE    VARCHAR2(100) DEFAULT ' '     NOT NULL,
    URL                VARCHAR2(500) DEFAULT ' '     NOT NULL,
    PREVIEW_URL        VARCHAR2(200) DEFAULT ' '     NOT NULL,
    SORT               NUMBER(20)  DEFAULT 0,
    UPLOAD_TYPE        VARCHAR2(20)  DEFAULT ' '     NOT NULL,
    ENCRYPTION_LEVEL   VARCHAR2(2)   DEFAULT '90'    NOT NULL,
    DEVICE_ID          VARCHAR2(100) DEFAULT ' '     NOT NULL,
    DOC_TYPE_ENAME     VARCHAR2(100) DEFAULT ' '     NOT NULL,
    FILE_TYPE          VARCHAR2(50)  DEFAULT ' '     NOT NULL,
    ORG_CODE           VARCHAR2(20)  DEFAULT ' '     NOT NULL,
    ORG_NAME           VARCHAR2(200) DEFAULT ' '     NOT NULL,
    FILE_STATUS        VARCHAR2(10)  DEFAULT 'sign'  NOT NULL,
    RESERVED_FIELD2    VARCHAR2(500) DEFAULT '0',
    RESERVED_FIELD3    VARCHAR2(500) DEFAULT '0',
    RESERVED_FIELD4    NUMBER(20)  DEFAULT 0,
    RESERVED_FIELD5    NUMBER(20)  DEFAULT 0,
    REC_CREATOR        VARCHAR2(64)  DEFAULT ' '     NOT NULL,
    REC_CREATE_TIME    VARCHAR2(17)  DEFAULT ' '     NOT NULL,
    REC_REVISOR        VARCHAR2(64),
    REC_REVISE_TIME    VARCHAR2(17),
    ARCHIVE_FLAG       VARCHAR2(1),
    TENANT_ID          VARCHAR2(32)  DEFAULT ' '     NOT NULL,
    FILE_ID            VARCHAR2(50)  DEFAULT ' '     NOT NULL,
    PLATFORM_CODE      VARCHAR2(10)  DEFAULT ' '     NOT NULL,
    DOC_TYPE           VARCHAR2(20)  DEFAULT ' '     NOT NULL,
    CUSTOM_FOLDER      VARCHAR2(20)  DEFAULT ' '     NOT NULL,
    CLIENT_ID          VARCHAR2(50)  DEFAULT ' '     NOT NULL,
    CONFIG_PATH_DEFINE VARCHAR2(200) DEFAULT '$$$$$' NOT NULL
);
ALTER TABLE TEUDM05 ADD CONSTRAINT PK_TEUDM05  PRIMARY KEY (RES_ID);

COMMENT ON TABLE TEUDM05 IS '信息资源-文档管理';
COMMENT ON COLUMN TEUDM05.RES_ID IS '资源ID';
COMMENT ON COLUMN TEUDM05.PROJECT_ENAME IS '项目英文名';
COMMENT ON COLUMN TEUDM05.APP_ID IS '应用标识';
COMMENT ON COLUMN TEUDM05.RES_TYPE IS '资源类型';
COMMENT ON COLUMN TEUDM05.RES_ENAME IS '资源英文名';
COMMENT ON COLUMN TEUDM05.RES_CNAME IS '资源中文名';
COMMENT ON COLUMN TEUDM05.IS_AUTH IS '是否授权';
COMMENT ON COLUMN TEUDM05.GROUP_ID IS '文件组名';
COMMENT ON COLUMN TEUDM05.STORAGE_TYPE IS '存储类型';
COMMENT ON COLUMN TEUDM05.BUCKET_NAME IS '桶名';
COMMENT ON COLUMN TEUDM05.FILE_EXTENSION IS '文件后缀名';
COMMENT ON COLUMN TEUDM05.FILE_SIZE IS '文件大小';
COMMENT ON COLUMN TEUDM05.FILE_HASH_VALUE IS '文件HASH值';
COMMENT ON COLUMN TEUDM05.URL IS '永久链接';
COMMENT ON COLUMN TEUDM05.PREVIEW_URL IS '预览链接';
COMMENT ON COLUMN TEUDM05.SORT IS '排序';
COMMENT ON COLUMN TEUDM05.UPLOAD_TYPE IS '上传类型';
COMMENT ON COLUMN TEUDM05.ENCRYPTION_LEVEL IS '加密级别';
COMMENT ON COLUMN TEUDM05.DEVICE_ID IS '设备ID';
COMMENT ON COLUMN TEUDM05.DOC_TYPE_ENAME IS '文档类型';
COMMENT ON COLUMN TEUDM05.FILE_TYPE IS '文件业务类型';
COMMENT ON COLUMN TEUDM05.ORG_CODE IS '组织机构编码';
COMMENT ON COLUMN TEUDM05.ORG_NAME IS '组织机构名称';
COMMENT ON COLUMN TEUDM05.FILE_STATUS IS '预留字段1';
COMMENT ON COLUMN TEUDM05.RESERVED_FIELD2 IS '预留字段2';
COMMENT ON COLUMN TEUDM05.RESERVED_FIELD3 IS '预留字段3';
COMMENT ON COLUMN TEUDM05.RESERVED_FIELD4 IS '预留字段4';
COMMENT ON COLUMN TEUDM05.RESERVED_FIELD5 IS '预留字段5';
COMMENT ON COLUMN TEUDM05.REC_CREATOR IS '创建者';
COMMENT ON COLUMN TEUDM05.REC_CREATE_TIME IS '记录创建时间';
COMMENT ON COLUMN TEUDM05.REC_REVISOR IS '修改者';
COMMENT ON COLUMN TEUDM05.REC_REVISE_TIME IS '记录修改时间';
COMMENT ON COLUMN TEUDM05.ARCHIVE_FLAG IS '归档标记';
COMMENT ON COLUMN TEUDM05.TENANT_ID IS '租户标识';
COMMENT ON COLUMN TEUDM05.CLIENT_ID IS '客服端标识';

CREATE TABLE TEUDM06
(
    CONFIG_OBJECT      VARCHAR2(50)  DEFAULT ' '     NOT NULL,
    CONFIG_OBJECT_NAME VARCHAR2(255) DEFAULT ' '     NOT NULL,
    DOC_TYPE           VARCHAR2(20)  DEFAULT ' '     NOT NULL,
    CUSTOM_FOLDER      VARCHAR2(32)  DEFAULT ' '     NOT NULL,
    CONFIG_PATH        VARCHAR2(255) DEFAULT ' '     NOT NULL,
    CONFIG_PATH_ID     VARCHAR2(20)  DEFAULT ' '     NOT NULL,
    CONFIG_PATH_DESC   VARCHAR2(255) DEFAULT ' '     NOT NULL,
    CONFIG_STATUS      VARCHAR2(10)  DEFAULT ' '     NOT NULL,
    IS_VERSION         VARCHAR2(1)   DEFAULT ' '     NOT NULL,
    SORT               NUMBER(11)    DEFAULT 10     NOT NULL,
    MEMO               VARCHAR2(255) DEFAULT ' '     NOT NULL,
    REC_CREATOR        VARCHAR2(64)  DEFAULT ' '     NOT NULL,
    REC_CREATOR_NAME   VARCHAR2(128) DEFAULT ' '     NOT NULL,
    REC_CREATE_TIME    VARCHAR2(17)  DEFAULT ' '     NOT NULL,
    REC_REVISOR        VARCHAR2(64)  DEFAULT ' '     NOT NULL,
    REC_REVISOR_NAME   VARCHAR2(128) DEFAULT ' '     NOT NULL,
    REC_REVISE_TIME    VARCHAR2(17)  DEFAULT ' '     NOT NULL,
    ARCHIVE_FLAG       VARCHAR2(1)   DEFAULT ' '     NOT NULL,
    CONFIG_PATH_DEFINE VARCHAR2(150) DEFAULT '$$$$$' NOT NULL
);
ALTER TABLE TEUDM06 ADD CONSTRAINT UI_TEUDM06 UNIQUE (CONFIG_OBJECT, CUSTOM_FOLDER, CONFIG_PATH_DEFINE);

COMMENT ON TABLE TEUDM06 IS '文档管理-文档类型';
COMMENT ON COLUMN TEUDM06.CONFIG_OBJECT IS '配置对象(应用英文名)';
COMMENT ON COLUMN TEUDM06.DOC_TYPE IS '文档类型';
COMMENT ON COLUMN TEUDM06.CUSTOM_FOLDER IS '自定义文件夹';
COMMENT ON COLUMN TEUDM06.CONFIG_PATH IS '文档路径';
COMMENT ON COLUMN TEUDM06.CONFIG_PATH_ID IS '配置路径标识';
COMMENT ON COLUMN TEUDM06.CONFIG_PATH_DESC IS '配置路径描述';
COMMENT ON COLUMN TEUDM06.CONFIG_STATUS IS '配置状态';
COMMENT ON COLUMN TEUDM06.IS_VERSION IS '是否支持版本管理';
COMMENT ON COLUMN TEUDM06.SORT IS '排序';
COMMENT ON COLUMN TEUDM06.MEMO IS '备注';
COMMENT ON COLUMN TEUDM06.REC_CREATOR IS '记录创建人';
COMMENT ON COLUMN TEUDM06.REC_CREATOR_NAME IS '记录创建人名称';
COMMENT ON COLUMN TEUDM06.REC_CREATE_TIME IS '记录创建时间';
COMMENT ON COLUMN TEUDM06.REC_REVISOR IS '记录修改人';
COMMENT ON COLUMN TEUDM06.REC_REVISOR_NAME IS '记录修改人名称';
COMMENT ON COLUMN TEUDM06.REC_REVISE_TIME IS '记录修改时间';
COMMENT ON COLUMN TEUDM06.ARCHIVE_FLAG IS '归档标记';
COMMENT ON COLUMN TEUDM06.CONFIG_PATH_DEFINE IS '自定义扩展路径';

CREATE TABLE TEUDM07
(
    DIR_ID          VARCHAR2(36)  DEFAULT ' ' NOT NULL,
    DIR_ENAME       VARCHAR2(256) DEFAULT ' ' NOT NULL,
    DIR_CNAME       VARCHAR2(64)  DEFAULT ' ' NOT NULL,
...
ALTER TABLE TEUDM07 ADD CONSTRAINT PK_TEUDM07 PRIMARY KEY (DIR_ID, PROJECT_ENAME, MODULE_ENAME);

CREATE TABLE TEDHG01
(
	LOGIN_NAME VARCHAR2(32) DEFAULT ' ' NOT NULL,
	TEMPLATE_ID VARCHAR2(64) DEFAULT ' ' NOT NULL,
	REC_CREATOR VARCHAR2(32) DEFAULT ' ' NOT NULL,
	REC_CREATE_TIME VARCHAR2(14) DEFAULT ' ' NOT NULL,
	REC_REVISOR VARCHAR2(32) DEFAULT ' ' NOT NULL,
	REC_REVISE_TIME VARCHAR2(14) DEFAULT ' ' NOT NULL,
...
ALTER TABLE TEDHG01 ADD CONSTRAINT PK_TEDHG01 PRIMARY KEY (LOGIN_NAME);

COMMENT ON TABLE TEDHG01 is '用户首页对应模板数量表';
COMMENT ON COLUMN TEDHG01.LOGIN_NAME is '登录人';
COMMENT ON COLUMN TEDHG01.TEMPLATE_ID is '模板ID';
COMMENT ON COLUMN TEDHG01.REC_CREATOR is '创建者';
COMMENT ON COLUMN TEDHG01.REC_CREATE_TIME is '创建时间';
COMMENT ON COLUMN TEDHG01.REC_REVISOR is '修改人';
COMMENT ON COLUMN TEDHG01.REC_REVISE_TIME is '修改时间';
COMMENT ON COLUMN TEDHG01.ARCHIVE_FLAG is '是否归档';

CREATE TABLE TEDHG02
(
	MODULE_ID VARCHAR2(64) DEFAULT ' ' NOT NULL,
	MODULE_CNAME VARCHAR2(50) DEFAULT ' ' NOT NULL,
	MODULE_LOAD_PATH VARCHAR2(250) DEFAULT ' ' NOT NULL,
	IMG_SRC VARCHAR2(250) DEFAULT ' ' NOT NULL,
	REC_CREATOR VARCHAR2(32) DEFAULT ' ' NOT NULL,
	REC_CREATE_TIME VARCHAR2(14) DEFAULT ' ' NOT NULL,
	REC_REVISOR VARCHAR2(32) DEFAULT ' ' NOT NULL,
	REC_REVISE_TIME VARCHAR2(14) DEFAULT ' ' NOT NULL,
	ARCHIVE_FLAG VARCHAR2(1) DEFAULT ' ' NOT NULL,
	MODULE_TYPE VARCHAR2(50) DEFAULT ' ' NOT NULL,
	TOMAX VARCHAR2(20)
);
ALTER TABLE TEDHG02 ADD CONSTRAINT PK_TEDHG02 PRIMARY KEY (MODULE_ID);

COMMENT ON TABLE TEDHG02 is '模板页面数据表';
COMMENT ON COLUMN TEDHG02.MODULE_ID is '页面号';
COMMENT ON COLUMN TEDHG02.MODULE_CNAME is '页面中文名';
COMMENT ON COLUMN TEDHG02.MODULE_LOAD_PATH is '页面对应路径';
COMMENT ON COLUMN TEDHG02.IMG_SRC is '图片路径';
COMMENT ON COLUMN TEDHG02.REC_CREATOR is '创造人';
COMMENT ON COLUMN TEDHG02.REC_CREATE_TIME is '创造时间';
COMMENT ON COLUMN TEDHG02.REC_REVISOR is '修改人';
COMMENT ON COLUMN TEDHG02.REC_REVISE_TIME is '修改时间';
COMMENT ON COLUMN TEDHG02.ARCHIVE_FLAG is '是否归档';
COMMENT ON COLUMN TEDHG02.MODULE_TYPE is '页面类型';
COMMENT ON COLUMN TEDHG02.TOMAX is '该组件在首页是否可以进入页面显示';

CREATE TABLE TEDHG03
(
	MODULE_ID VARCHAR2(64) DEFAULT ' ' NOT NULL,
	LOGIN_NAME VARCHAR2(50) DEFAULT ' ' NOT NULL,
	MODULE_INDEX NUMBER(11) DEFAULT 0,
	REC_CREATOR VARCHAR2(32) DEFAULT ' ' NOT NULL,
	REC_CREATE_TIME VARCHAR2(14) DEFAULT ' ' NOT NULL,
	REC_REVISOR VARCHAR2(32) DEFAULT ' ' NOT NULL,
	REC_REVISE_TIME VARCHAR2(14) DEFAULT ' ' NOT NULL,
	ARCHIVE_FLAG VARCHAR2(1) DEFAULT ' ' NOT NULL,
	QUOTA_PARAMS VARCHAR2(500) DEFAULT ' ' NOT NULL
);

COMMENT ON TABLE TEDHG03 is '模板页面用户关系表';
COMMENT ON COLUMN TEDHG03.MODULE_ID is '页面号';
COMMENT ON COLUMN TEDHG03.LOGIN_NAME is '登录名';
COMMENT ON COLUMN TEDHG03.MODULE_INDEX is '页面index';
COMMENT ON COLUMN TEDHG03.REC_CREATOR is '创建人';
COMMENT ON COLUMN TEDHG03.REC_CREATE_TIME is '创建时间';
COMMENT ON COLUMN TEDHG03.REC_REVISOR is '修改人';
COMMENT ON COLUMN TEDHG03.REC_REVISE_TIME is '修改时间';
COMMENT ON COLUMN TEDHG03.ARCHIVE_FLAG is '是否归档';
COMMENT ON COLUMN TEDHG03.QUOTA_PARAMS is '传入页面的参数';


--自定义导入导出
create table TEDIG0601
(
    SCHEME_ID       VARCHAR2(50) default ' ' not null,
    SCHEME_NAME     VARCHAR2(50) default ' ' not null,
    REC_CREATOR     VARCHAR2(16) default ' ' not null,
    REC_CREATE_TIME VARCHAR2(17) default ' ' not null,
    REC_REVISOR     VARCHAR2(16) default ' ' not null,
    ARCHIVE_FLAG    VARCHAR2(1)  default ' ' not null,
    REC_REVISE_TIME VARCHAR2(17) default ' ' not null,
    constraint PK_TEDIG0601_SCHEME_ID
        primary key (SCHEME_ID)
);
comment on column TEDIG0601.SCHEME_ID is 'ID';
comment on column TEDIG0601.SCHEME_NAME is '方案名称';
comment on column TEDIG0601.REC_CREATOR is '创建人';
comment on column TEDIG0601.REC_CREATE_TIME is '创建时间';
comment on column TEDIG0601.REC_REVISOR is '修改人';
comment on column TEDIG0601.ARCHIVE_FLAG is '归档标记';
comment on column TEDIG0601.REC_REVISE_TIME is '修改时间';

create table TEDIG0602
(
    FID             VARCHAR2(50) default ' ' not null,
    CONFIG_CODE     VARCHAR2(50) default ' ' not null,
    CONFIG_NAME     VARCHAR2(50) default ' ' not null,
    TABLE_NAME      VARCHAR2(50) default ' ' not null,
    SCHEME_NAME     VARCHAR2(50) default ' ' not null,
    SCHEME_ID       VARCHAR2(50) default ' ' not null,
    REC_CREATOR     VARCHAR2(16) default ' ' not null,
    REC_CREATE_TIME VARCHAR2(17) default ' ' not null,
    ...
    ARCHIVE_FLAG    VARCHAR2(1)  default ' ' not null,
    REC_REVISE_TIME VARCHAR2(17) default ' ' not null,
    constraint PK_TEDIG0602_FID
        primary key (FID)
);

comment on column TEDIG0602.FID is 'FID';
comment on column TEDIG0602.CONFIG_CODE is '配置代码';
comment on column TEDIG0602.CONFIG_NAME is '配置名';
comment on column TEDIG0602.TABLE_NAME is '表名';
comment on column TEDIG0602.SCHEME_NAME is '方案名称';
comment on column TEDIG0602.SCHEME_ID is '方案名称';
comment on column TEDIG0602.REC_CREATOR is '创建人';
comment on column TEDIG0602.REC_CREATE_TIME is '创建时间';
comment on column TEDIG0602.REC_REVISOR is '修改人';
comment on column TEDIG0602.ARCHIVE_FLAG is '归档标记';
comment on column TEDIG0602.REC_REVISE_TIME is '修改时间';

create table TEDIG0603
(
    CID             VARCHAR2(50) default ' ' not null,
    SCHEME_ID       VARCHAR2(50) default ' ' not null,
    FID             VARCHAR2(50) default ' ' not null,
    SORT_INDEX      VARCHAR2(10) default ' ' not null,
    LOGICAL_SYMBOL  VARCHAR2(10) default ' ' not null,
    LEFT_SYMBOL     VARCHAR2(10) default ' ' not null,
    FIELD_NAME      VARCHAR2(50) default ' ' not null,
    MATCH_SYMBOL    VARCHAR2(10) default ' ' not null,
    VALUE1          VARCHAR2(50) default ' ' not null,
    RIGHT_SYMBOL    VARCHAR2(10) default ' ' not null,
    REC_CREATOR     VARCHAR2(16) default ' ' not null,
    REC_CREATE_TIME VARCHAR2(17) default ' ' not null,
    REC_REVISOR     VARCHAR2(16) default ' ' not null,
    REC_REVISE_TIME VARCHAR2(17) default ' ' not null,
    ARCHIVE_FLAG    VARCHAR2(1)  default ' ' not null,
    constraint PK_TEDIG0603_CID
        primary key (CID)
);

comment on column TEDIG0603.CID is 'CID';
comment on column TEDIG0603.SCHEME_ID is '配置方案ID';
comment on column TEDIG0603.FID is '与表2关联的FID';
comment on column TEDIG0603.SORT_INDEX is '序列号';
comment on column TEDIG0603.LOGICAL_SYMBOL is '逻辑符';
comment on column TEDIG0603.LEFT_SYMBOL is '左括号';
comment on column TEDIG0603.FIELD_NAME is '字段名';
comment on column TEDIG0603.MATCH_SYMBOL is '匹配符';
comment on column TEDIG0603.VALUE1 is '值';
comment on column TEDIG0603.RIGHT_SYMBOL is '右括号';
comment on column TEDIG0603.REC_CREATOR is '创建人';
comment on column TEDIG0603.REC_CREATE_TIME is '创建时间';
comment on column TEDIG0603.REC_REVISOR is '修改人';
comment on column TEDIG0603.REC_REVISE_TIME is '修改时间';
comment on column TEDIG0603.ARCHIVE_FLAG is '归档标记';

create table TEDIG0701
(
    CONFIG_CODE     VARCHAR2(50) default ' ' not null,
    CONFIG_NAME     VARCHAR2(50) default ' ' not null,
    PAGE_CODE       VARCHAR2(50) default ' ' not null,
    TABLE_NAME      VARCHAR2(50) default ' ' not null,
    USE_RESOURCE    VARCHAR2(10) default ' ' not null,
    IMP_SERVICE     VARCHAR2(50) default ' ' not null,
    EXP_SERVICE     VARCHAR2(50) default ' ' not null,
    NUM             VARCHAR2(50) default ' ' not null,
    REC_CREATOR     VARCHAR2(16) default ' ' not null,
    REC_CREATE_TIME VARCHAR2(17) default ' ' not null,
    REC_REVISOR     VARCHAR2(16) default ' ' not null,
    REC_REVISE_TIME VARCHAR2(17) default ' ' not null,
    ARCHIVE_FLAG    VARCHAR2(1)  default ' ' not null,
    constraint PK_TEDIG0701_CONFIG_CODE
        primary key (CONFIG_CODE)
);

comment on column TEDIG0701.CONFIG_CODE is '配置代码';
comment on column TEDIG0701.CONFIG_NAME is '配置名';
comment on column TEDIG0701.PAGE_CODE is '画面代码';
comment on column TEDIG0701.TABLE_NAME is '表名';
comment on column TEDIG0701.USE_RESOURCE is '使用资源表';
comment on column TEDIG0701.IMP_SERVICE is '导入Service';
comment on column TEDIG0701.EXP_SERVICE is '导出Service';
comment on column TEDIG0701.NUM is '批量';
comment on column TEDIG0701.REC_CREATOR is '创建人';
comment on column TEDIG0701.REC_CREATE_TIME is '创建时间';
comment on column TEDIG0701.REC_REVISOR is '修改人';
comment on column TEDIG0701.REC_REVISE_TIME is '修改时间';
comment on column TEDIG0701.ARCHIVE_FLAG is '归档标记';

create table TEDIG0702
(
    COLUMN_ID       VARCHAR2(50)  default ' ' not null,
    COLUMN_NAME     VARCHAR2(50)  default ' ' not null,
    COLUMN_DES      VARCHAR2(50)  default ' ' not null,
    CONFIG_CODE     VARCHAR2(50)  default ' ' not null,
    IS_QUERY        VARCHAR2(10)  default ' ' not null,
    IS_PRIMARY      VARCHAR2(10)  default ' ' not null,
    BELANG_RESOURCE VARCHAR2(10)  default ' ' not null,
    FLWATER_NO      VARCHAR2(50)  default ' ' not null,
    FLWATER_CHANGE  VARCHAR2(100) default ' ' not null,
    SHOW_CODE       VARCHAR2(100) default ' ' not null,
    OPERATION_TYPE  VARCHAR2(100) default ' ' not null,
    REC_CREATOR     VARCHAR2(16)  default ' ' not null,
    REC_CREATE_TIME VARCHAR2(17)  default ' ' not null,
    REC_REVISOR     VARCHAR2(16)  default ' ' not null,
    REC_REVISE_TIME VARCHAR2(17)  default ' ' not null,
    ARCHIVE_FLAG    VARCHAR2(1)   default ' ' not null,
    constraint PK_TEDIG0702_COLUMN_ID
        primary key (COLUMN_ID)
);

comment on column TEDIG0702.COLUMN_ID is 'ID';
comment on column TEDIG0702.COLUMN_NAME is '列名';
comment on column TEDIG0702.COLUMN_DES is '列描述';
comment on column TEDIG0702.CONFIG_CODE is '配置代码';
comment on column TEDIG0702.IS_QUERY is '是否查询条件';
comment on column TEDIG0702.IS_PRIMARY is '是否主键';
comment on column TEDIG0702.BELANG_RESOURCE is '属于资源表';
comment on column TEDIG0702.FLWATER_NO is '流水号';
comment on column TEDIG0702.FLWATER_CHANGE is '流水号转换';
comment on column TEDIG0702.SHOW_CODE is '显示代码';
comment on column TEDIG0702.OPERATION_TYPE is '操作类型';
comment on column TEDIG0702.REC_CREATOR is '创建人';
comment on column TEDIG0702.REC_CREATE_TIME is '创建时间';
comment on column TEDIG0702.REC_REVISOR is '修改人';
comment on column TEDIG0702.REC_REVISE_TIME is '修改时间';
comment on column TEDIG0702.ARCHIVE_FLAG is '归档标记';

--消息履历队列分离
create table EM_RECEIVE_HI_LOG
(
    ...
    RETURN_STATUS      VARCHAR2(10),
    OPERATE_START_TIME VARCHAR2(20),
    OPERATE_RESULT     NUMBER(5),
    OPERATE_END_TIME   VARCHAR2(14),
    OPERATE_COUNT      NUMBER(5),
    SERVICE_NAME       VARCHAR2(128),
    METHOD_NAME        VARCHAR2(128),
    RPC_TYPE           VARCHAR2(64),
    MESSAGE_BODY       BLOB,
    ...
    EVENT_ID           VARCHAR2(128),
    HTTP_STATUS        VARCHAR2(16),
    OPERATE_START_DATE TIMESTAMP default SYSDATE,
    constraint PK_EM_RECEIVE_HI_LOG
        primary key (ID)
);

comment on column EM_RECEIVE_HI_LOG.ID is 'UUID';
comment on column EM_RECEIVE_HI_LOG.CATEGORY is '消息分类(SEND:发送消息,RECEIVE:接收消息)';
comment on column EM_RECEIVE_HI_LOG.STATE is '消息调用状态';
comment on column EM_RECEIVE_HI_LOG.RETURN_STATUS is '调用消息返回状态';
comment on column EM_RECEIVE_HI_LOG.OPERATE_START_TIME is '开始调用时间';
comment on column EM_RECEIVE_HI_LOG.OPERATE_RESULT is '调用结果';
comment on column EM_RECEIVE_HI_LOG.OPERATE_END_TIME is '结束调用时间';
comment on column EM_RECEIVE_HI_LOG.OPERATE_COUNT is '调用结果';
comment on column EM_RECEIVE_HI_LOG.SERVICE_NAME is '服务调用方法名';
comment on column EM_RECEIVE_HI_LOG.METHOD_NAME is '服务调用方法名';
comment on column EM_RECEIVE_HI_LOG.RPC_TYPE is '调用类型';
comment on column EM_RECEIVE_HI_LOG.MESSAGE_BODY is '消息内容';
comment on column EM_RECEIVE_HI_LOG.PROJECT_NAME is '项目英文名';
comment on column EM_RECEIVE_HI_LOG.MOUDLE_NAME is '模块英文名';
comment on column EM_RECEIVE_HI_LOG.SEND_ADDRESS is '消息发送方地址';
comment on column EM_RECEIVE_HI_LOG.RECEIVE_ADDRESS is '消息接收方地址';
comment on column EM_RECEIVE_HI_LOG.EXT1 is '扩展字段1';
comment on column EM_RECEIVE_HI_LOG.EXT2 is '扩展字段2';
comment on column EM_RECEIVE_HI_LOG.EXT3 is '业务信息';
comment on column EM_RECEIVE_HI_LOG.GROUP_NAME is '消息接收方地址';
comment on column EM_RECEIVE_HI_LOG.EVENT_ID is '事件ID';
comment on column EM_RECEIVE_HI_LOG.HTTP_STATUS is 'HTTP状态';
create index IDX_EM_RECEIVE_HI_LOG
  on EM_RECEIVE_HI_LOG (OPERATE_START_TIME, OPERATE_END_TIME, EVENT_ID, SERVICE_NAME, METHOD_NAME, CATEGORY,
                        RETURN_STATUS);


create table EM_RECEIVE_HISTORY
(
    ID                 VARCHAR2(50) default ' ' not null,
    CATEGORY           VARCHAR2(16),
    STATE              VARCHAR2(16),
    ...
    EVENT_ID           VARCHAR2(128),
    HTTP_STATUS        VARCHAR2(16),
    constraint PK_EM_SEND_HISTORY
        primary key (ID)
);

comment on column EM_RECEIVE_HISTORY.ID is 'UUID';
comment on column EM_RECEIVE_HISTORY.CATEGORY is '消息分类(SEND:发送消息,RECEIVE:接收消息)';
comment on column EM_RECEIVE_HISTORY.STATE is '消息调用状态';
comment on column EM_RECEIVE_HISTORY.RETURN_STATUS is '调用消息返回状态';
comment on column EM_RECEIVE_HISTORY.OPERATE_START_TIME is '开始调用时间';
comment on column EM_RECEIVE_HISTORY.OPERATE_RESULT is '调用结果';
comment on column EM_RECEIVE_HISTORY.OPERATE_END_TIME is '结束调用时间';
comment on column EM_RECEIVE_HISTORY.OPERATE_COUNT is '调用结果';
comment on column EM_RECEIVE_HISTORY.SERVICE_NAME is '服务调用方法名';
comment on column EM_RECEIVE_HISTORY.METHOD_NAME is '服务调用方法名';
comment on column EM_RECEIVE_HISTORY.RPC_TYPE is '调用类型';
comment on column EM_RECEIVE_HISTORY.MESSAGE_BODY is '消息内容';
comment on column EM_RECEIVE_HISTORY.PROJECT_NAME is '项目英文名';
comment on column EM_RECEIVE_HISTORY.MOUDLE_NAME is '模块英文名';
comment on column EM_RECEIVE_HISTORY.SEND_ADDRESS is '消息发送方地址';
comment on column EM_RECEIVE_HISTORY.RECEIVE_ADDRESS is '消息接收方地址';
comment on column EM_RECEIVE_HISTORY.EXT1 is '扩展字段1';
comment on column EM_RECEIVE_HISTORY.EXT2 is '扩展字段2';
comment on column EM_RECEIVE_HISTORY.EXT3 is '业务信息';
comment on column EM_RECEIVE_HISTORY.GROUP_NAME is '消息接收方地址';
comment on column EM_RECEIVE_HISTORY.EVENT_ID is '事件ID';
comment on column EM_RECEIVE_HISTORY.HTTP_STATUS is 'HTTP状态';
create index IDX_EM_RECEIVE_HISTORY
  on EM_RECEIVE_HISTORY (OPERATE_START_TIME, OPERATE_END_TIME, EVENT_ID, SERVICE_NAME, METHOD_NAME, CATEGORY,
                         RETURN_STATUS);


create table EM_RECEIVE_PROC_HI_LOG
(
    ORI_UUID           VARCHAR2(50)   default ' ' not null,
    GROUP_NAME         VARCHAR2(128)  default ' ' not null,
    OPERATE_START_TIME VARCHAR2(20)   default ' ' not null,
    OPERATE_RESULT     NUMBER(5)    default 0   not null,
    OPERATE_END_TIME   VARCHAR2(20)   default ' ' not null,
    EXT1               VARCHAR2(255)  default ' ' not null,
    EXT2               VARCHAR2(255)  default ' ' not null,
    EXT3               VARCHAR2(4000) default ' ' not null,
    PROCESS_UUID       VARCHAR2(50)   default ' ' not null,
    TRACE_ID           VARCHAR2(50)   default ' ' not null,
    RETURN_BODY        BLOB            not null,
    HTTP_STATUS        VARCHAR2(16)   default ' ' not null,
    OPERATE_START_DATE TIMESTAMP  default SYSDATE,
    constraint PK_EM_RECEIVE_PROC_HI_LOG
        primary key (PROCESS_UUID)
);

comment on table EM_RECEIVE_PROC_HI_LOG is '接收结果履历表';
comment on column EM_RECEIVE_PROC_HI_LOG.ORI_UUID is '消息UUID';
comment on column EM_RECEIVE_PROC_HI_LOG.GROUP_NAME is '队列名称';
comment on column EM_RECEIVE_PROC_HI_LOG.OPERATE_START_TIME is '操作开始时间';
comment on column EM_RECEIVE_PROC_HI_LOG.OPERATE_RESULT is '操作结果';
comment on column EM_RECEIVE_PROC_HI_LOG.OPERATE_END_TIME is '操作结束时间';
comment on column EM_RECEIVE_PROC_HI_LOG.EXT1 is '扩展字段1';
comment on column EM_RECEIVE_PROC_HI_LOG.EXT2 is '扩展字段2';
comment on column EM_RECEIVE_PROC_HI_LOG.EXT3 is '扩展字段3';
comment on column EM_RECEIVE_PROC_HI_LOG.PROCESS_UUID is 'PROCESS_UUID';
comment on column EM_RECEIVE_PROC_HI_LOG.TRACE_ID is '处理链路ID';
comment on column EM_RECEIVE_PROC_HI_LOG.RETURN_BODY is '处理完成后处理内容';
comment on column EM_RECEIVE_PROC_HI_LOG.HTTP_STATUS is '远程调用Http状态记录';

create table EM_RECEIVE_PROC_HISTORY
(
    ORI_UUID           VARCHAR2(50)  default ' ' not null,
    GROUP_NAME         VARCHAR2(128) default ' ' not null,
    OPERATE_START_TIME VARCHAR2(20)  default ' ' not null,
    ...
    EXT1               VARCHAR2(255) default ' ' not null,
    EXT2               VARCHAR2(255) default ' ' not null,
    EXT3               VARCHAR2(255) default ' ' not null,
    PROCESS_UUID       VARCHAR2(50)  default ' ' not null,
    TRACE_ID           VARCHAR2(50)  default ' ' not null,
    RETURN_BODY        BLOB            not null,
    HTTP_STATUS        VARCHAR2(16)  default ' ' not null,
    constraint PK_EM_RECEIVE_PROC_HISTORY
        primary key (PROCESS_UUID)
);

comment on table EM_RECEIVE_PROC_HISTORY is '接收结果履历表';
comment on column EM_RECEIVE_PROC_HISTORY.ORI_UUID is '消息UUID';
comment on column EM_RECEIVE_PROC_HISTORY.GROUP_NAME is '队列名称';
comment on column EM_RECEIVE_PROC_HISTORY.OPERATE_START_TIME is '操作开始时间';
comment on column EM_RECEIVE_PROC_HISTORY.OPERATE_RESULT is '操作结果';
comment on column EM_RECEIVE_PROC_HISTORY.OPERATE_END_TIME is '操作结束时间';
comment on column EM_RECEIVE_PROC_HISTORY.EXT1 is '扩展字段1';
comment on column EM_RECEIVE_PROC_HISTORY.EXT2 is '扩展字段2';
comment on column EM_RECEIVE_PROC_HISTORY.EXT3 is '扩展字段3';
comment on column EM_RECEIVE_PROC_HISTORY.PROCESS_UUID is 'PROCESS_UUID';
comment on column EM_RECEIVE_PROC_HISTORY.TRACE_ID is '处理链路ID';
comment on column EM_RECEIVE_PROC_HISTORY.RETURN_BODY is '处理完成后处理内容';
comment on column EM_RECEIVE_PROC_HISTORY.HTTP_STATUS is '远程调用Http状态记录';

create table EM_RECEIVE_QUEUE
(
    QUEUE_UUID         VARCHAR2(50)  default ' ' not null,
    ORI_UUID           VARCHAR2(50)  default ' ' not null,
    GROUP_NAME         VARCHAR2(128) default ' ' not null,
    INCOME_TIME        VARCHAR2(20)  default ' ' not null,
    OPERATE_START_TIME VARCHAR2(20)  default ' ' not null,
    OPERATE_RESULT     NUMBER(5)   default 0   not null,
    OPERATE_END_TIME   VARCHAR2(20)  default ' ' not null,
    QUEUE_STAUS        VARCHAR2(20)  default ' ' not null,
    constraint PK_EM_RECIVE_QUEUE
        primary key (QUEUE_UUID)
);

comment on table EM_RECEIVE_QUEUE is '接收队列表';
comment on column EM_RECEIVE_QUEUE.QUEUE_UUID is '队列ID';
comment on column EM_RECEIVE_QUEUE.ORI_UUID is '消息UUID';
comment on column EM_RECEIVE_QUEUE.GROUP_NAME is '队列名称';
comment on column EM_RECEIVE_QUEUE.INCOME_TIME is '入队时间';
comment on column EM_RECEIVE_QUEUE.OPERATE_START_TIME is '操作开始时间';
comment on column EM_RECEIVE_QUEUE.OPERATE_RESULT is '操作结果';
comment on column EM_RECEIVE_QUEUE.OPERATE_END_TIME is '操作结束时间';
comment on column EM_RECEIVE_QUEUE.QUEUE_STAUS is '队列状态';

create table EM_SEND_HI_LOG
(
    ID                 VARCHAR2(50)  default ' ' not null,
    CATEGORY           VARCHAR2(16),
    STATE              VARCHAR2(16),
    ...
    HTTP_STATUS        VARCHAR2(16),
    OPERATE_START_DATE TIMESTAMP default SYSDATE,
    constraint PK_EM_SEND_HI_LOG
        primary key (ID)
);

create index IDX_EM_SEND_HI_LOG
  on EM_SEND_HI_LOG (OPERATE_START_TIME, OPERATE_END_TIME, EVENT_ID, SERVICE_NAME, METHOD_NAME, CATEGORY,
                     RETURN_STATUS);

create table EM_SEND_HISTORY
(
    ID                 VARCHAR2(50) default ' ' not null,
    CATEGORY           VARCHAR2(16),
    STATE              VARCHAR2(16),
    ...
    EVENT_ID           VARCHAR2(128),
    HTTP_STATUS        VARCHAR2(16),
    constraint PK_EM_RECEIVE_HISTORY
        primary key (ID)
);

create index IDX_EM_SEND_HISTORY
  on EM_SEND_HISTORY (OPERATE_START_TIME, OPERATE_END_TIME, EVENT_ID, SERVICE_NAME, METHOD_NAME, CATEGORY,
                      RETURN_STATUS);


create table EM_SEND_PROC_HI_LOG
(
    ORI_UUID           VARCHAR2(50)   default ' ' not null,
    GROUP_NAME         VARCHAR2(128)  default ' ' not null,
    OPERATE_START_TIME VARCHAR2(20)   default ' ' not null,
    ...
    HTTP_STATUS        VARCHAR2(16)   default ' ' not null,
    OPERATE_START_DATE TIMESTAMP  default SYSDATE,
    constraint PK_EM_SEND_PROC_HI_LOG
        primary key (PROCESS_UUID)
);

comment on table EM_SEND_PROC_HI_LOG is '发送消息结果履历归档表';
comment on column EM_SEND_PROC_HI_LOG.ORI_UUID is '消息UUID';
comment on column EM_SEND_PROC_HI_LOG.GROUP_NAME is '队列名称';
comment on column EM_SEND_PROC_HI_LOG.OPERATE_START_TIME is '操作开始时间';
comment on column EM_SEND_PROC_HI_LOG.OPERATE_RESULT is '操作结果';
comment on column EM_SEND_PROC_HI_LOG.OPERATE_END_TIME is '操作结束时间';
comment on column EM_SEND_PROC_HI_LOG.EXT1 is '扩展字段1';
comment on column EM_SEND_PROC_HI_LOG.EXT2 is '扩展字段2';
comment on column EM_SEND_PROC_HI_LOG.EXT3 is '扩展字段3';
comment on column EM_SEND_PROC_HI_LOG.PROCESS_UUID is 'PROCESS_UUID';
comment on column EM_SEND_PROC_HI_LOG.TRACE_ID is '处理链路ID';
comment on column EM_SEND_PROC_HI_LOG.RETURN_BODY is '处理完成后处理内容';
comment on column EM_SEND_PROC_HI_LOG.HTTP_STATUS is '远程调用Http状态记录';

create table EM_SEND_PROC_HISTORY
(
    ORI_UUID           VARCHAR2(50)  default ' ' not null,
    GROUP_NAME         VARCHAR2(128) default ' ' not null,
    OPERATE_START_TIME VARCHAR2(20)  default ' ' not null,
    ...
    RETURN_BODY        BLOB          not null,
    HTTP_STATUS        VARCHAR2(16)  default ' ' not null,
    constraint PK_EM_SEND_PROC_HISTORY
        primary key (PROCESS_UUID)
);

comment on table EM_SEND_PROC_HISTORY is '发送消息结果履历表';
comment on column EM_SEND_PROC_HISTORY.ORI_UUID is '消息UUID';
comment on column EM_SEND_PROC_HISTORY.GROUP_NAME is '队列名称';
comment on column EM_SEND_PROC_HISTORY.OPERATE_START_TIME is '操作开始时间';
comment on column EM_SEND_PROC_HISTORY.OPERATE_RESULT is '操作结果';
comment on column EM_SEND_PROC_HISTORY.OPERATE_END_TIME is '操作结束时间';
comment on column EM_SEND_PROC_HISTORY.EXT1 is '扩展字段1';
comment on column EM_SEND_PROC_HISTORY.EXT2 is '扩展字段2';
comment on column EM_SEND_PROC_HISTORY.EXT3 is '扩展字段3';
comment on column EM_SEND_PROC_HISTORY.PROCESS_UUID is 'PROCESS_UUID';
comment on column EM_SEND_PROC_HISTORY.TRACE_ID is '处理链路ID';
comment on column EM_SEND_PROC_HISTORY.RETURN_BODY is '处理完成后处理内容';
comment on column EM_SEND_PROC_HISTORY.HTTP_STATUS is '远程调用Http状态记录';

create table EM_SEND_QUEUE
(
    QUEUE_UUID         VARCHAR2(50)  default ' ' not null,
    ORI_UUID           VARCHAR2(50)  default ' ' not null,
    GROUP_NAME         VARCHAR2(128) default ' ' not null,
    ...
    OPERATE_END_TIME   VARCHAR2(20)  default ' ' not null,
    QUEUE_STAUS        VARCHAR2(20)  default ' ' not null,
    constraint PK_EM_SEND_QUEUE
        primary key (QUEUE_UUID)
);

comment on table EM_SEND_QUEUE is '发送队列表';
comment on column EM_SEND_QUEUE.QUEUE_UUID is '队列ID';
comment on column EM_SEND_QUEUE.ORI_UUID is '消息UUID';
comment on column EM_SEND_QUEUE.GROUP_NAME is '队列名称';
comment on column EM_SEND_QUEUE.INCOME_TIME is '入队时间';
comment on column EM_SEND_QUEUE.OPERATE_START_TIME is '操作开始时间';
comment on column EM_SEND_QUEUE.OPERATE_RESULT is '操作结果';
comment on column EM_SEND_QUEUE.OPERATE_END_TIME is '操作结束时间';
comment on column EM_SEND_QUEUE.QUEUE_STAUS is '队列状态';


CREATE TABLE HEDCC03
(
    LOG_UUID            VARCHAR2(32)  DEFAULT ' '   NOT NULL,
    CONFIG_TYPE         VARCHAR2(255)  DEFAULT ' '   NOT NULL,
    STATUS              NUMBER(11,0),
    CONFIG_CUE          VARCHAR2(255),
    CONFIG_ENV_ID       VARCHAR2(50)  DEFAULT ' '   NOT NULL,
    FKEY                VARCHAR2(255)  DEFAULT ' '   NOT NULL,
    ...
    CONFIG_DESC         VARCHAR2(255),
    OPERATOR            VARCHAR2(32)  DEFAULT ' '   NOT NULL,
    OPERATE_TYPE        VARCHAR2(32)  DEFAULT ' '   NOT NULL,
    OPERATE_TIME        VARCHAR2(17)  DEFAULT ' '   NOT NULL,
    ORI_VALUE           VARCHAR2(4000)  DEFAULT ' '   NOT NULL,
    NEW_VALUE           VARCHAR2(4000)  DEFAULT ' '   NOT NULL
);
...
(
    ...
    ARCHIVE_FLAG           VARCHAR2(1)  DEFAULT ' '   NOT NULL,
    REC_REVISE_TIME        VARCHAR2(17)  DEFAULT ' '   NOT NULL,
    URL_CONFIG_ENAME       VARCHAR2(32)  DEFAULT ' '   NOT NULL,
    CONFIG_DESC            VARCHAR2(255)  DEFAULT ' '   NOT NULL,
    MATCH_TYPE             VARCHAR2(10)  DEFAULT ' '   NOT NULL,
    MATCH_EXPRESSION       VARCHAR2(4000)  DEFAULT ' '   NOT NULL,
    IS_AUTHORIZED          VARCHAR2(1)  DEFAULT ' '   NOT NULL,
    CONFIG_ID              VARCHAR2(32)  DEFAULT ' '   NOT NULL,
    SORT_INDEX             NUMBER(5,0)  DEFAULT 0   NOT NULL
);
...
(
    ...
    ARCHIVE_FLAG                  VARCHAR2(1)  DEFAULT ' '   NOT NULL,
    REC_REVISE_TIME               VARCHAR2(17)  DEFAULT ' '   NOT NULL,
    AUTH_ID                       VARCHAR2(32)  DEFAULT ' '   NOT NULL,
    AUTH_TYPE_CODE                VARCHAR2(32)  DEFAULT ' '   NOT NULL,
    AUTH_TYPE_DESC                VARCHAR2(255)  DEFAULT ' '   NOT NULL,
    AUTH_SERVICE_CONFIG           VARCHAR2(255)  DEFAULT ' '   NOT NULL,
    AUTH_OBJE_QUERY_SERVICE       VARCHAR2(255)  DEFAULT ' '   NOT NULL
);
...
(
    ...
    URL_CONFIG_ENAME         VARCHAR2(32)  DEFAULT ' '   NOT NULL,
    AUTH_TYPE_CODE           VARCHAR2(32)  DEFAULT ' '   NOT NULL,
    AUTH_SUBJECT_ID          VARCHAR2(32)  DEFAULT ' '   NOT NULL,
    AUTH_SUBJECT_ENAME       VARCHAR2(64)  DEFAULT ' '   NOT NULL,
    AUTH_SUBJECT_DESC        VARCHAR2(255)  DEFAULT ' '   NOT NULL
);
...
CREATE TABLE
    ...
    (
        ...
        I18N_TEXT VARCHAR(5000) DEFAULT ' ' NOT NULL,
        I18N_LOACLE VARCHAR(10) DEFAULT ' ' NOT NULL,
        PRIMARY KEY (I18N_KEY, I18N_LOACLE)
    );
