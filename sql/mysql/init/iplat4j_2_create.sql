...
create index IDX_TXSHR04_EMP_CODE
    on TXSHR04 (EMP_CODE);

create index IDX_TXSHR04_ORG_CODE
    on TXSHR04 (ORG_CODE);
...
(
    ...
    REC_REVISE_TIME VARCHAR(14),
    primary key (EMP_CODE, EMP_ORIGIN_CODE)
) ENGINE=INNODB DEFAULT CHARSET=UTF8 COLLATE UTF8_BIN;
...
(
    ...
    PROJECT_ENAME      VARCHAR(50)  DEFAULT ' '     NOT NULL COMMENT '项目英文名',
    APP_ID             VARCHAR(50)  DEFAULT ' '     NOT NULL COMMENT '应用标识',
    RES_TYPE           VARCHAR(10)                  NOT NULL COMMENT '资源类型',
    RES_ENAME          VARCHAR(100) DEFAULT ' '     NOT NULL COMMENT '资源英文名',
    RES_CNAME          VARCHAR(500) DEFAULT ' '     NOT NULL COMMENT '资源中文名',
    IS_AUTH            VARCHAR(1)   DEFAULT '0'     NOT NULL COMMENT '是否授权',
    GROUP_ID           VARCHAR(36)  DEFAULT ' '     NOT NULL COMMENT '文件组名',
    STORAGE_TYPE       VARCHAR(10)  DEFAULT ' '     NOT NULL COMMENT '存储类型',
    BUCKET_NAME        VARCHAR(100) DEFAULT ' '     NOT NULL COMMENT '桶名',
    FILE_EXTENSION     VARCHAR(100) DEFAULT ' '     NOT NULL COMMENT '文件后缀名',
    FILE_SIZE          DECIMAL(20)  DEFAULT 0       NOT NULL COMMENT '文件大小',
    FILE_HASH_VALUE    VARCHAR(100) DEFAULT ' '     NOT NULL COMMENT '文件HASH值',
    URL                VARCHAR(500) DEFAULT ' '     NOT NULL COMMENT '永久链接',
    PREVIEW_URL        VARCHAR(200) DEFAULT ' '     NOT NULL COMMENT '预览链接',
    SORT               DECIMAL(20)  DEFAULT 0  COMMENT '排序',
    UPLOAD_TYPE        VARCHAR(20)  DEFAULT ' '     NOT NULL COMMENT '上传类型',
    ENCRYPTION_LEVEL   VARCHAR(2)   DEFAULT '90'    NOT NULL COMMENT '加密级别',
    DEVICE_ID          VARCHAR(100) DEFAULT ' '     NOT NULL COMMENT '设备ID',
    DOC_TYPE_ENAME     VARCHAR(100) DEFAULT ' '     NOT NULL COMMENT '文档类型',
    FILE_TYPE          VARCHAR(50)  DEFAULT ' '     NOT NULL COMMENT '文件业务类型',
    ORG_CODE           VARCHAR(20)  DEFAULT ' '     NOT NULL COMMENT '组织机构编码',
    ORG_NAME           VARCHAR(200) DEFAULT ' '     NOT NULL COMMENT '组织机构名称',
    FILE_STATUS        VARCHAR(10)  DEFAULT 'sign'  NOT NULL COMMENT '文件状态',
    RESERVED_FIELD2    VARCHAR(500) DEFAULT '0' COMMENT '预留字段2',
    RESERVED_FIELD3    VARCHAR(500) DEFAULT '0' COMMENT '预留字段3',
    RESERVED_FIELD4    DECIMAL(20)  DEFAULT 0 COMMENT '预留字段4',
    RESERVED_FIELD5    DECIMAL(20)  DEFAULT 0 COMMENT '预留字段5',
    REC_CREATOR        VARCHAR(64)  DEFAULT ' '     NOT NULL COMMENT '创建者',
    REC_CREATE_TIME    VARCHAR(17)  DEFAULT ' '     NOT NULL COMMENT '记录创建时间',
    REC_REVISOR        VARCHAR(64) COMMENT '修改者',
    REC_REVISE_TIME    VARCHAR(17) COMMENT '记录修改时间',
    ARCHIVE_FLAG       VARCHAR(1) COMMENT '归档标记',
    TENANT_ID          VARCHAR(32)  DEFAULT ' '     NOT NULL COMMENT '租户标识',
    FILE_ID            VARCHAR(50)  DEFAULT ' '     NOT NULL COMMENT '',
    PLATFORM_CODE      VARCHAR(10)  DEFAULT ' '     NOT NULL COMMENT '',
    DOC_TYPE           VARCHAR(20)  DEFAULT ' '     NOT NULL COMMENT '',
    CUSTOM_FOLDER      VARCHAR(20)  DEFAULT ' '     NOT NULL COMMENT '',
    CLIENT_ID          VARCHAR(50)  DEFAULT ' '     NOT NULL COMMENT '客户端标识',
    CONFIG_PATH_DEFINE VARCHAR(200) DEFAULT '$$$$$' NOT NULL,
    CONSTRAINT PK_TEUDM05 PRIMARY KEY (RES_ID)
)COMMENT='信息资源-文档管理' ENGINE=INNODB DEFAULT CHARSET=UTF8 COLLATE UTF8_BIN;

CREATE TABLE TEUDM06
(
    CONFIG_OBJECT      VARCHAR(50)  DEFAULT ' '     NOT NULL COMMENT '配置对象(应用英文名)',
    CONFIG_OBJECT_NAME VARCHAR(255) DEFAULT ' '     NOT NULL COMMENT '',
    DOC_TYPE           VARCHAR(20)  DEFAULT ' '     NOT NULL COMMENT '文档类型',
    CUSTOM_FOLDER      VARCHAR(32)  DEFAULT ' '     NOT NULL COMMENT '自定义文件夹',
    CONFIG_PATH        VARCHAR(255) DEFAULT ' '     NOT NULL COMMENT '文档路径',
    CONFIG_PATH_ID     VARCHAR(20)  DEFAULT ' '     NOT NULL COMMENT '配置路径标识',
    CONFIG_PATH_DESC   VARCHAR(255) DEFAULT ' '     NOT NULL COMMENT '配置路径描述',
    CONFIG_STATUS      VARCHAR(10)  DEFAULT ' '     NOT NULL COMMENT '配置状态',
    IS_VERSION         VARCHAR(1)   DEFAULT ' '     NOT NULL COMMENT '是否支持版本管理',
    SORT               INTEGER      DEFAULT 10      NOT NULL COMMENT '排序',
    MEMO               VARCHAR(255) DEFAULT ' '     NOT NULL COMMENT '备注',
    REC_CREATOR        VARCHAR(64)  DEFAULT ' '     NOT NULL COMMENT '记录创建人',
    REC_CREATOR_NAME   VARCHAR(128) DEFAULT ' '     NOT NULL COMMENT '记录创建人名称',
    REC_CREATE_TIME    VARCHAR(17)  DEFAULT ' '     NOT NULL COMMENT '记录创建时间',
    REC_REVISOR        VARCHAR(64)  DEFAULT ' '     NOT NULL COMMENT '记录修改人',
    REC_REVISOR_NAME   VARCHAR(128) DEFAULT ' '     NOT NULL COMMENT '记录修改人名称',
    REC_REVISE_TIME    VARCHAR(17)  DEFAULT ' '     NOT NULL COMMENT '记录修改时间',
    ARCHIVE_FLAG       VARCHAR(1)   DEFAULT ' '     NOT NULL COMMENT '归档标记',
    CONFIG_PATH_DEFINE VARCHAR(150) DEFAULT '$$$$$' NOT NULL COMMENT '自定义扩展路径',
    CONSTRAINT UI_TEUDM06
        UNIQUE (CONFIG_OBJECT, CUSTOM_FOLDER, CONFIG_PATH_DEFINE)
)COMMENT='文档管理-文档类型' ENGINE=INNODB DEFAULT CHARSET=UTF8 COLLATE UTF8_BIN;
...
(
	LOGIN_NAME VARCHAR(32) DEFAULT ' ' NOT NULL  COMMENT '登录人',
	TEMPLATE_ID VARCHAR(64) DEFAULT ' ' NOT NULL COMMENT '模板ID',
	REC_CREATOR VARCHAR(32) DEFAULT ' ' NOT NULL COMMENT '创建者',
	REC_CREATE_TIME VARCHAR(14) DEFAULT ' ' NOT NULL COMMENT '创建时间',
	REC_REVISOR VARCHAR(32) DEFAULT ' ' NOT NULL COMMENT '修改人',
	REC_REVISE_TIME VARCHAR(14) DEFAULT ' ' NOT NULL COMMENT '修改时间',
	ARCHIVE_FLAG VARCHAR(1) DEFAULT ' ' NOT NULL COMMENT '是否归档',
	CONSTRAINT PK_TEDHG01
			PRIMARY KEY(LOGIN_NAME)
)COMMENT='用户首页对应模板数量表' ENGINE=INNODB DEFAULT CHARSET=UTF8 COLLATE UTF8_BIN;

CREATE TABLE TEDHG02
(
	MODULE_ID VARCHAR(64) DEFAULT ' ' NOT NULL COMMENT '页面号',
	MODULE_CNAME VARCHAR(50) DEFAULT ' ' NOT NULL COMMENT '页面中文名',
	MODULE_LOAD_PATH VARCHAR(250) DEFAULT ' ' NOT NULL COMMENT '页面对应路径',
	IMG_SRC VARCHAR(250) DEFAULT ' ' NOT NULL COMMENT '图片路径',
	REC_CREATOR VARCHAR(32) DEFAULT ' ' NOT NULL COMMENT '创造人',
	REC_CREATE_TIME VARCHAR(14) DEFAULT ' ' NOT NULL COMMENT '创造时间',
	REC_REVISOR VARCHAR(32) DEFAULT ' ' NOT NULL COMMENT '修改人',
	REC_REVISE_TIME VARCHAR(14) DEFAULT ' ' NOT NULL COMMENT '修改时间',
	ARCHIVE_FLAG VARCHAR(1) DEFAULT ' ' NOT NULL COMMENT '是否归档',
	MODULE_TYPE VARCHAR(50) DEFAULT ' ' NOT NULL COMMENT '页面类型',
	TOMAX VARCHAR(20) COMMENT '该组件在首页是否可以进入页面显示',
	CONSTRAINT PK_TEDHG02
			PRIMARY KEY(MODULE_ID)
)COMMENT='模板页面数据表' ENGINE=INNODB DEFAULT CHARSET=UTF8 COLLATE UTF8_BIN;

CREATE TABLE TEDHG03
(
    MODULE_ID VARCHAR(64) DEFAULT ' ' NOT NULL COMMENT '页面号',
	LOGIN_NAME VARCHAR(50) DEFAULT ' ' NOT NULL COMMENT '登录名',
	MODULE_INDEX DECIMAL(11) DEFAULT 0 COMMENT '页面index',
	REC_CREATOR VARCHAR(32) DEFAULT ' ' NOT NULL COMMENT '创建人',
	REC_CREATE_TIME VARCHAR(14) DEFAULT ' ' NOT NULL COMMENT '创建时间',
	REC_REVISOR VARCHAR(32) DEFAULT ' ' NOT NULL COMMENT '修改人',
	REC_REVISE_TIME VARCHAR(14) DEFAULT ' ' NOT NULL COMMENT '修改时间',
	ARCHIVE_FLAG VARCHAR(1) DEFAULT ' ' NOT NULL COMMENT '是否归档',
	QUOTA_PARAMS VARCHAR(500) DEFAULT ' ' NOT NULL COMMENT '传入页面的参数'
)COMMENT='模板页面用户关系表' ENGINE=INNODB DEFAULT CHARSET=UTF8 COLLATE UTF8_BIN;



create table TEDIG0601
(
    SCHEME_ID       VARCHAR(50) COLLATE utf8_bin  default ' ' not null,
    SCHEME_NAME     VARCHAR(50) COLLATE utf8_bin  default ' ' not null,
    REC_CREATOR     VARCHAR(16) COLLATE utf8_bin  default ' ' not null,
    REC_CREATE_TIME VARCHAR(17) COLLATE utf8_bin  default ' ' not null,
    REC_REVISOR     VARCHAR(16) COLLATE utf8_bin  default ' ' not null,
    ARCHIVE_FLAG    VARCHAR(1) COLLATE utf8_bin  default ' ' not null,
...
(
    FID             VARCHAR(50) COLLATE utf8_bin  default ' ' not null,
    CONFIG_CODE     VARCHAR(50) COLLATE utf8_bin  default ' ' not null,
    CONFIG_NAME     VARCHAR(50) COLLATE utf8_bin  default ' ' not null,
    TABLE_NAME      VARCHAR(50) COLLATE utf8_bin  default ' ' not null,
    SCHEME_NAME     VARCHAR(50) COLLATE utf8_bin  default ' ' not null,
    SCHEME_ID       VARCHAR(50) COLLATE utf8_bin  default ' ' not null,
    REC_CREATOR     VARCHAR(16) COLLATE utf8_bin  default ' ' not null,
    REC_CREATE_TIME VARCHAR(17) COLLATE utf8_bin  default ' ' not null,
...
(
    CID             VARCHAR(50) COLLATE utf8_bin  default ' ' not null,
    SCHEME_ID       VARCHAR(50) COLLATE utf8_bin  default ' ' not null,
    FID             VARCHAR(50) COLLATE utf8_bin  default ' ' not null,
    SORT_INDEX      VARCHAR(10) COLLATE utf8_bin  default ' ' not null,
    LOGICAL_SYMBOL  VARCHAR(10) COLLATE utf8_bin  default ' ' not null,
    LEFT_SYMBOL     VARCHAR(10) COLLATE utf8_bin  default ' ' not null,
    FIELD_NAME      VARCHAR(50) COLLATE utf8_bin  default ' ' not null,
    MATCH_SYMBOL    VARCHAR(10) COLLATE utf8_bin  default ' ' not null,
    VALUE1          VARCHAR(50) COLLATE utf8_bin  default ' ' not null,
    RIGHT_SYMBOL    VARCHAR(10) COLLATE utf8_bin  default ' ' not null,
    REC_CREATOR     VARCHAR(16) COLLATE utf8_bin  default ' ' not null,
    REC_CREATE_TIME VARCHAR(17) COLLATE utf8_bin  default ' ' not null,
    REC_REVISOR     VARCHAR(16) COLLATE utf8_bin  default ' ' not null,
    REC_REVISE_TIME VARCHAR(17) COLLATE utf8_bin  default ' ' not null,
...
(
    CONFIG_CODE     VARCHAR(50) COLLATE utf8_bin default ' ' not null,
    CONFIG_NAME     VARCHAR(50) COLLATE utf8_bin default ' ' not null,
    PAGE_CODE       VARCHAR(50) COLLATE utf8_bin default ' ' not null,
    TABLE_NAME      VARCHAR(50) COLLATE utf8_bin default ' ' not null,
    USE_RESOURCE    VARCHAR(10) COLLATE utf8_bin default ' ' not null,
    IMP_SERVICE     VARCHAR(50) COLLATE utf8_bin default ' ' not null,
    EXP_SERVICE     VARCHAR(50) COLLATE utf8_bin default ' ' not null,
    NUM             VARCHAR(50) COLLATE utf8_bin default ' ' not null,
    REC_CREATOR     VARCHAR(16) COLLATE utf8_bin default ' ' not null,
    REC_CREATE_TIME VARCHAR(17) COLLATE utf8_bin default ' ' not null,
    REC_REVISOR     VARCHAR(16) COLLATE utf8_bin default ' ' not null,
    REC_REVISE_TIME VARCHAR(17) COLLATE utf8_bin default ' ' not null,
...
(
    COLUMN_ID       VARCHAR(50) COLLATE utf8_bin default ' ' not null,
    COLUMN_NAME     VARCHAR(50) COLLATE utf8_bin default ' ' not null,
    COLUMN_DES      VARCHAR(50) COLLATE utf8_bin default ' ' not null,
    CONFIG_CODE     VARCHAR(50) COLLATE utf8_bin default ' ' not null,
    IS_QUERY        VARCHAR(10) COLLATE utf8_bin default ' ' not null,
    IS_PRIMARY      VARCHAR(10) COLLATE utf8_bin default ' ' not null,
    BELANG_RESOURCE VARCHAR(10) COLLATE utf8_bin default ' ' not null,
    FLWATER_NO      VARCHAR(50) COLLATE utf8_bin default ' ' not null,
    FLWATER_CHANGE  VARCHAR(100) COLLATE utf8_bin default ' ' not null,
    SHOW_CODE       VARCHAR(100) COLLATE utf8_bin default ' ' not null,
    OPERATION_TYPE  VARCHAR(100) COLLATE utf8_bin default ' ' not null,
    REC_CREATOR     VARCHAR(16) COLLATE utf8_bin default ' ' not null,
    REC_CREATE_TIME VARCHAR(17) COLLATE utf8_bin default ' ' not null,
    REC_REVISOR     VARCHAR(16) COLLATE utf8_bin default ' ' not null,
    REC_REVISE_TIME VARCHAR(17) COLLATE utf8_bin default ' ' not null,
...
(
    ID                 VARCHAR(50) COLLATE utf8_bin default ' ' not null,
    CATEGORY           VARCHAR(16) COLLATE utf8_bin,
    STATE              VARCHAR(16) COLLATE utf8_bin,
    RETURN_STATUS      VARCHAR(10) COLLATE utf8_bin,
    OPERATE_START_TIME VARCHAR(20) COLLATE utf8_bin,
    OPERATE_RESULT     DECIMAL(5) COLLATE utf8_bin,
    OPERATE_END_TIME   VARCHAR(14) COLLATE utf8_bin,
    OPERATE_COUNT      DECIMAL(5) COLLATE utf8_bin,
    SERVICE_NAME       VARCHAR(128) COLLATE utf8_bin,
    METHOD_NAME        VARCHAR(128) COLLATE utf8_bin,
    RPC_TYPE           VARCHAR(64) COLLATE utf8_bin,
    MESSAGE_BODY       BLOB(2097152),
    PROJECT_NAME       VARCHAR(64) COLLATE utf8_bin,
    MOUDLE_NAME        VARCHAR(64) COLLATE utf8_bin,
    SEND_ADDRESS       VARCHAR(255) COLLATE utf8_bin,
    RECEIVE_ADDRESS    VARCHAR(255) COLLATE utf8_bin,
    EXT1               VARCHAR(255) COLLATE utf8_bin,
    EXT2               VARCHAR(255) COLLATE utf8_bin,
    EXT3               VARCHAR(4000) COLLATE utf8_bin,
    GROUP_NAME         VARCHAR(128) COLLATE utf8_bin,
    EVENT_ID           VARCHAR(128) COLLATE utf8_bin,
    HTTP_STATUS        VARCHAR(16) COLLATE utf8_bin,
    OPERATE_START_DATE TIMESTAMP default CURRENT_TIMESTAMP,
...
(
    ...
    EXT1               VARCHAR(255) COLLATE utf8_bin,
    EXT2               VARCHAR(255) COLLATE utf8_bin,
    EXT3               VARCHAR(255) COLLATE utf8_bin,
    GROUP_NAME         VARCHAR(128) COLLATE utf8_bin,
    EVENT_ID           VARCHAR(128) COLLATE utf8_bin,
    HTTP_STATUS        VARCHAR(16) COLLATE utf8_bin,
...
(
    ORI_UUID           VARCHAR(50) COLLATE utf8_bin default ' ' not null,
    GROUP_NAME         VARCHAR(128) COLLATE utf8_bin default ' ' not null,
    OPERATE_START_TIME VARCHAR(20) COLLATE utf8_bin  default ' ' not null,
    OPERATE_RESULT     DECIMAL(5)  COLLATE utf8_bin  default 0   not null,
    OPERATE_END_TIME   VARCHAR(20)  COLLATE utf8_bin default ' ' not null,
    EXT1               VARCHAR(255) COLLATE utf8_bin default ' ' not null,
    EXT2               VARCHAR(255) COLLATE utf8_bin default ' ' not null,
    EXT3               VARCHAR(4000) COLLATE utf8_bin default ' ' not null,
    PROCESS_UUID       VARCHAR(50)  COLLATE utf8_bin default ' ' not null,
    TRACE_ID           VARCHAR(50)  COLLATE utf8_bin default ' ' not null,
    RETURN_BODY        BLOB(2097152)   not null,
    HTTP_STATUS        VARCHAR(16) COLLATE utf8_bin  default ' ' not null,
    OPERATE_START_DATE TIMESTAMP COLLATE utf8_bin default CURRENT_TIMESTAMP,
...
(
    ...
    EXT1               VARCHAR(255) COLLATE utf8_bin default ' ' not null,
    EXT2               VARCHAR(255) COLLATE utf8_bin default ' ' not null,
    EXT3               VARCHAR(255) COLLATE utf8_bin default ' ' not null,
    PROCESS_UUID       VARCHAR(50) COLLATE utf8_bin default ' ' not null,
    TRACE_ID           VARCHAR(50) COLLATE utf8_bin default ' ' not null,
    RETURN_BODY        BLOB(2097152)            not null,
    HTTP_STATUS        VARCHAR(16) COLLATE utf8_bin default ' ' not null,
...
(
    QUEUE_UUID         VARCHAR(50) COLLATE utf8_bin default ' ' not null,
    ORI_UUID           VARCHAR(50) COLLATE utf8_bin default ' ' not null,
    GROUP_NAME         VARCHAR(128) COLLATE utf8_bin default ' ' not null,
    INCOME_TIME        VARCHAR(20) COLLATE utf8_bin default ' ' not null,
    OPERATE_START_TIME VARCHAR(20) COLLATE utf8_bin default ' ' not null,
    OPERATE_RESULT     DECIMAL(5)  COLLATE utf8_bin default 0   not null,
    OPERATE_END_TIME   VARCHAR(20) COLLATE utf8_bin default ' ' not null,
    QUEUE_STAUS        VARCHAR(20) COLLATE utf8_bin default ' ' not null,
...
(
    ...
    METHOD_NAME        VARCHAR(128) COLLATE utf8_bin,
    RPC_TYPE           VARCHAR(64) COLLATE utf8_bin,
    MESSAGE_BODY       BLOB(2097152) not null,
    PROJECT_NAME       VARCHAR(64) COLLATE utf8_bin,
    MOUDLE_NAME        VARCHAR(64) COLLATE utf8_bin,
    SEND_ADDRESS       VARCHAR(255) COLLATE utf8_bin,
    RECEIVE_ADDRESS    VARCHAR(255) COLLATE utf8_bin,
...
CREATE TABLE
    ...
    (
        ...
        I18N_TEXT VARCHAR(5000) DEFAULT ' ' NOT NULL COMMENT '国际化定义值',
...
DROP FUNCTION IF EXISTS queryOrgPath;
...
--/
CREATE FUNCTION queryOrgPath(queryId varchar(32)) returns varchar(21845)
BEGIN
        DECLARE sTemp VARCHAR(21845);
        DECLARE sTempChd VARCHAR(21845);
        SET sTemp = '$';
        ...
        SELECT group_concat(parent_org_id) INTO sTempChd FROM txsog01 where org_id <> parent_org_id
        and is_deleted != '1'
        and FIND_IN_SET(org_id,sTempChd)>0;
        END WHILE;
        RETURN sTemp;
END;
/
