...
(
    RES_ID             VARCHAR(50)                  NOT NULL
        CONSTRAINT PK_TEUDM05
            PRIMARY KEY,
    PROJECT_ENAME      VARCHAR(50)  DEFAULT ' '     NOT NULL,
    APP_ID             VARCHAR(50)  DEFAULT ' '     NOT NULL,
    RES_TYPE           VARCHAR(10)                  NOT NULL,
    RES_ENAME          VARCHAR(100) DEFAULT ' '     NOT NULL,
    RES_CNAME          VARCHAR(500) DEFAULT ' '     NOT NULL,
    IS_AUTH            VARCHAR(1)   DEFAULT '0'     NOT NULL,
    GROUP_ID           VARCHAR(36)  DEFAULT ' '     NOT NULL,
    STORAGE_TYPE       VARCHAR(10)  DEFAULT ' '     NOT NULL,
    BUCKET_NAME        VARCHAR(100) DEFAULT ' '     NOT NULL,
    FILE_EXTENSION     VARCHAR(100) DEFAULT ' '     NOT NULL,
    FILE_SIZE          DECIMAL(20)  DEFAULT 0       NOT NULL,
    FILE_HASH_VALUE    VARCHAR(100) DEFAULT ' '     NOT NULL,
    URL                VARCHAR(500) DEFAULT ' '     NOT NULL,
    PREVIEW_URL        VARCHAR(200) DEFAULT ' '     NOT NULL,
    SORT               DECIMAL(20)  DEFAULT 0,
    UPLOAD_TYPE        VARCHAR(20)  DEFAULT ' '     NOT NULL,
    ENCRYPTION_LEVEL   VARCHAR(2)   DEFAULT '90'    NOT NULL,
    DEVICE_ID          VARCHAR(100) DEFAULT ' '     NOT NULL,
    DOC_TYPE_ENAME     VARCHAR(100) DEFAULT ' '     NOT NULL,
    FILE_TYPE          VARCHAR(50)  DEFAULT ' '     NOT NULL,
    ORG_CODE           VARCHAR(20)  DEFAULT ' '     NOT NULL,
    ORG_NAME           VARCHAR(200) DEFAULT ' '     NOT NULL,
    FILE_STATUS        VARCHAR(10)  DEFAULT 'sign'  NOT NULL,
    RESERVED_FIELD2    VARCHAR(500) DEFAULT '0',
    RESERVED_FIELD3    VARCHAR(500) DEFAULT '0',
    RESERVED_FIELD4    DECIMAL(20)  DEFAULT 0,
    RESERVED_FIELD5    DECIMAL(20)  DEFAULT 0,
    REC_CREATOR        VARCHAR(64)  DEFAULT ' '     NOT NULL,
    REC_CREATE_TIME    VARCHAR(17)  DEFAULT ' '     NOT NULL,
    REC_REVISOR        VARCHAR(64),
    REC_REVISE_TIME    VARCHAR(17),
    ARCHIVE_FLAG       VARCHAR(1),
    TENANT_ID          VARCHAR(32)  DEFAULT ' '     NOT NULL,
    FILE_ID            VARCHAR(50)  DEFAULT ' '     NOT NULL,
    PLATFORM_CODE      VARCHAR(10)  DEFAULT ' '     NOT NULL,
    DOC_TYPE           VARCHAR(20)  DEFAULT ' '     NOT NULL,
    CUSTOM_FOLDER      VARCHAR(20)  DEFAULT ' '     NOT NULL,
    CLIENT_ID          VARCHAR(50)  DEFAULT ' '     NOT NULL,
    CONFIG_PATH_DEFINE VARCHAR(200) DEFAULT '$$$$$' NOT NULL
)IN DS_IPLAT4J01;
...
(
    CONFIG_OBJECT      VARCHAR(50)  DEFAULT ' '     NOT NULL,
    CONFIG_OBJECT_NAME VARCHAR(255) DEFAULT ' '     NOT NULL,
    DOC_TYPE           VARCHAR(20)  DEFAULT ' '     NOT NULL,
    CUSTOM_FOLDER      VARCHAR(32)  DEFAULT ' '     NOT NULL,
    CONFIG_PATH        VARCHAR(255) DEFAULT ' '     NOT NULL,
    CONFIG_PATH_ID     VARCHAR(20)  DEFAULT ' '     NOT NULL,
    CONFIG_PATH_DESC   VARCHAR(255) DEFAULT ' '     NOT NULL,
    CONFIG_STATUS      VARCHAR(10)  DEFAULT ' '     NOT NULL,
    IS_VERSION         VARCHAR(1)   DEFAULT ' '     NOT NULL,
    SORT               INTEGER      DEFAULT 10      NOT NULL,
    MEMO               VARCHAR(255) DEFAULT ' '     NOT NULL,
    REC_CREATOR        VARCHAR(64)  DEFAULT ' '     NOT NULL,
    REC_CREATOR_NAME   VARCHAR(128) DEFAULT ' '     NOT NULL,
    REC_CREATE_TIME    VARCHAR(17)  DEFAULT ' '     NOT NULL,
    REC_REVISOR        VARCHAR(64)  DEFAULT ' '     NOT NULL,
    REC_REVISOR_NAME   VARCHAR(128) DEFAULT ' '     NOT NULL,
    REC_REVISE_TIME    VARCHAR(17)  DEFAULT ' '     NOT NULL,
    ARCHIVE_FLAG       VARCHAR(1)   DEFAULT ' '     NOT NULL,
    CONFIG_PATH_DEFINE VARCHAR(150) DEFAULT '$$$$$' NOT NULL,
    CONSTRAINT UI_TEUDM06
        UNIQUE (CONFIG_OBJECT, CUSTOM_FOLDER, CONFIG_PATH_DEFINE)
)IN DS_IPLAT4J01;
...
(
	MODULE_ID VARCHAR(64) DEFAULT ' ' NOT NULL,
	MODULE_CNAME VARCHAR(50) DEFAULT ' ' NOT NULL,
	MODULE_LOAD_PATH VARCHAR(250) DEFAULT ' ' NOT NULL,
	IMG_SRC VARCHAR(250) DEFAULT ' ' NOT NULL,
	REC_CREATOR VARCHAR(32) DEFAULT ' ' NOT NULL,
	REC_CREATE_TIME VARCHAR(14) DEFAULT ' ' NOT NULL,
	REC_REVISOR VARCHAR(32) DEFAULT ' ' NOT NULL,
	REC_REVISE_TIME VARCHAR(14) DEFAULT ' ' NOT NULL,
...
(
	...
	MODULE_INDEX DECIMAL(11) DEFAULT 0,
	REC_CREATOR VARCHAR(32) DEFAULT ' ' NOT NULL,
	REC_CREATE_TIME VARCHAR(14) DEFAULT ' ' NOT NULL,
	REC_REVISOR VARCHAR(32) DEFAULT ' ' NOT NULL,
	REC_REVISE_TIME VARCHAR(14) DEFAULT ' ' NOT NULL,
	ARCHIVE_FLAG VARCHAR(1) DEFAULT ' ' NOT NULL,
	QUOTA_PARAMS VARCHAR(500) DEFAULT ' ' NOT NULL
)IN DS_IPLAT4J01;
...
(
    SCHEME_ID       VARCHAR(50) default ' ' not null,
    SCHEME_NAME     VARCHAR(50) default ' ' not null,
    REC_CREATOR     VARCHAR(16) default ' ' not null,
    REC_CREATE_TIME VARCHAR(17) default ' ' not null,
    REC_REVISOR     VARCHAR(16) default ' ' not null,
    ARCHIVE_FLAG    VARCHAR(1)  default ' ' not null,
...
(
    ...
    SCHEME_ID       VARCHAR(50) default ' ' not null,
    FID             VARCHAR(50) default ' ' not null,
    SORT_INDEX      VARCHAR(10) default ' ' not null,
    LOGICAL_SYMBOL  VARCHAR(10) default ' ' not null,
    LEFT_SYMBOL     VARCHAR(10) default ' ' not null,
    FIELD_NAME      VARCHAR(50) default ' ' not null,
    MATCH_SYMBOL    VARCHAR(10) default ' ' not null,
    VALUE1          VARCHAR(50) default ' ' not null,
    RIGHT_SYMBOL    VARCHAR(10) default ' ' not null,
    REC_CREATOR     VARCHAR(16) default ' ' not null,
    REC_CREATE_TIME VARCHAR(17) default ' ' not null,
    REC_REVISOR     VARCHAR(16) default ' ' not null,
    REC_REVISE_TIME VARCHAR(17) default ' ' not null,
...
(
    CONFIG_CODE     VARCHAR(50) default ' ' not null,
    CONFIG_NAME     VARCHAR(50) default ' ' not null,
    PAGE_CODE       VARCHAR(50) default ' ' not null,
    TABLE_NAME      VARCHAR(50) default ' ' not null,
    USE_RESOURCE    VARCHAR(10) default ' ' not null,
    IMP_SERVICE     VARCHAR(50) default ' ' not null,
    EXP_SERVICE     VARCHAR(50) default ' ' not null,
...
(
    COLUMN_ID       VARCHAR(50)  default ' ' not null,
    COLUMN_NAME     VARCHAR(50)  default ' ' not null,
    COLUMN_DES      VARCHAR(50)  default ' ' not null,
    CONFIG_CODE     VARCHAR(50)  default ' ' not null,
    IS_QUERY        VARCHAR(10)  default ' ' not null,
    IS_PRIMARY      VARCHAR(10)  default ' ' not null,
    BELANG_RESOURCE VARCHAR(10)  default ' ' not null,
    FLWATER_NO      VARCHAR(50)  default ' ' not null,
    FLWATER_CHANGE  VARCHAR(100) default ' ' not null,
    SHOW_CODE       VARCHAR(100) default ' ' not null,
    OPERATION_TYPE  VARCHAR(100) default ' ' not null,
    REC_CREATOR     VARCHAR(16)  default ' ' not null,
    REC_CREATE_TIME VARCHAR(17)  default ' ' not null,
    REC_REVISOR     VARCHAR(16)  default ' ' not null,
    REC_REVISE_TIME VARCHAR(17)  default ' ' not null,
...
(
    ...
    RETURN_STATUS      VARCHAR(10),
    OPERATE_START_TIME VARCHAR(20),
    OPERATE_RESULT     DECIMAL(5),
    OPERATE_END_TIME   VARCHAR(14),
    OPERATE_COUNT      DECIMAL(5),
    SERVICE_NAME       VARCHAR(128),
    METHOD_NAME        VARCHAR(128),
    RPC_TYPE           VARCHAR(64),
    MESSAGE_BODY       BLOB(2097152),
    ...
    EVENT_ID           VARCHAR(128),
    HTTP_STATUS        VARCHAR(16),
    OPERATE_START_DATE TIMESTAMP default CURRENT TIMESTAMP,
...
(
    ORI_UUID           VARCHAR(50)   default ' ' not null,
    GROUP_NAME         VARCHAR(128)  default ' ' not null,
    OPERATE_START_TIME VARCHAR(20)   default ' ' not null,
    OPERATE_RESULT     DECIMAL(5)    default 0   not null,
    OPERATE_END_TIME   VARCHAR(20)   default ' ' not null,
    EXT1               VARCHAR(255)  default ' ' not null,
    EXT2               VARCHAR(255)  default ' ' not null,
    EXT3               VARCHAR(4000) default ' ' not null,
    PROCESS_UUID       VARCHAR(50)   default ' ' not null,
    TRACE_ID           VARCHAR(50)   default ' ' not null,
    RETURN_BODY        BLOB(2097152)             not null,
    HTTP_STATUS        VARCHAR(16)   default ' ' not null,
    OPERATE_START_DATE TIMESTAMP  default CURRENT TIMESTAMP,
...
(
    ...
    EXT1               VARCHAR(255) default ' ' not null,
    EXT2               VARCHAR(255) default ' ' not null,
    EXT3               VARCHAR(255) default ' ' not null,
    PROCESS_UUID       VARCHAR(50)  default ' ' not null,
    TRACE_ID           VARCHAR(50)  default ' ' not null,
    RETURN_BODY        BLOB(2097152)            not null,
    HTTP_STATUS        VARCHAR(16)  default ' ' not null,
...
(
    QUEUE_UUID         VARCHAR(50)  default ' ' not null,
    ORI_UUID           VARCHAR(50)  default ' ' not null,
    GROUP_NAME         VARCHAR(128) default ' ' not null,
    INCOME_TIME        VARCHAR(20)  default ' ' not null,
    OPERATE_START_TIME VARCHAR(20)  default ' ' not null,
    OPERATE_RESULT     DECIMAL(5)   default 0   not null,
    OPERATE_END_TIME   VARCHAR(20)  default ' ' not null,
    QUEUE_STAUS        VARCHAR(20)  default ' ' not null,
